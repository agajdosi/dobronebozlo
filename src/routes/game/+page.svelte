<script lang="ts">
    ...
    const israeliImages: ImageData[] = [
        { image: `${assets}/israeli/1.jpg`, label: 'Good', location: 'Beit Lahia', date: '2023-12-28', source: 'https://www.972mag.com/lavender-ai-israeli-army-gaza/' },
        { image: `${assets}/israeli/2.jpg`, label: 'Good', location: 'Jabalia', date: '2023-12-16', source: 'https://www.sn.at/politik/weltpolitik/dutzende-palaestinenser-luftangriffen-150220012' },
        { image: `${assets}/israeli/3.jpg`, label: 'Good', location: 'Gaza City', date: '2024-02-23', source: 'https://tangselife.com/news/akibat-keganasan-israel-29-410-warga-gaza-tewas-69-465-orang-terluka' },
        { image: `${assets}/israeli/4.jpg`, label: 'Good', location: 'Palestina', date: '2021-05-13', source: 'https://www.doctorswithoutborders.org/latest/heavy-bombing-israel-causing-catastrophic-situation-gaza' },
        { image: `${assets}/israeli/5.jpg`, label: 'Good', location: 'Northern Gaza', date: '2024-11-08', source: 'https://www.archyde.com/84-more-palestinian-martyrs-in-new-attacks-claim-to-kill-last-senior-leader-of-hamas-world/' },
        { image: `${assets}/israeli/6.jpg`, label: 'Good', location: 'Beit Lahiya', date: '2024-01-10', source: 'https://www.morgenpost.de/politik/article241392442/Deutschland-muss-Israel-beistehen-es-geht-nicht-anders.html' },
        { image: `${assets}/israeli/7.jpg`, label: 'Good', location: 'Watan Tower', date: '2023-10-08', source: 'https://commons.wikimedia.org/wiki/File:Damage_in_Gaza_Strip_during_the_October_2023_-_06.jpg' },
        { image: `${assets}/israeli/8.jpg`, label: 'Good', location: 'Nuseirat Refugee Camp', date: '2024-06-08', source: 'https://www.pahomepage.com/news/international/ap-ultimate-surprise-how-an-israeli-raid-freed-4-hostages-and-killed-scores-of-palestinians-in-gaza/' },
        { image: `${assets}/israeli/9.jpg`, label: 'Good', location: 'Beit Lahyia', date: '2024-10-27', source: 'https://wenewsenglish.pk/hamas-condemns-israeli-airstrikes-in-beit-lahia/' },
        { image: `${assets}/israeli/10.jpg`, label: 'Good', location: 'Nuseirat Refugee Camp', date: '2024-07-20', source: 'https://www.seznamzpravy.cz/clanek/zahranicni-desitky-mrtvych-za-den-nasili-v-pasmu-gazy-nepolevuje-256254' },
